...
import org.usfirst.frc4579.Curiosity.subsystems.*;
...
public class OI {
    ...
    public JoystickButton switchCamera_Button;
    ...
    public OI() {
        ...
        invertDriveButton = new JoystickButton(joystick, 12);
        invertDriveButton.whenPressed(new invertDrive());
        intakeButton = new JoystickButton(joystick, 4);
        intakeButton.whileHeld(new intakeBall());
        ejectButton = new JoystickButton(joystick, 3);
        ejectButton.whileHeld(new ejectBall());
        switchCamera_Button = new JoystickButton(joystick, 11);
        switchCamera_Button.whenPressed(new switchCameras());
        ...
        SmartDashboard.putData("updateVision", new updateVision());
